 ...
 */
public class ScoreFragment_unified_ui extends Fragment {
    ...
    private int[] scoreArray = {1,3,6,9,12};
    private int i_scoreArray = 0;
    private int instantScore = 1;
    private String mTeam1 = "Nós";
    private String mTeam2 = "Eles";
    private static ScoreFragment_unified_ui ins;
    ...
    public ScoreFragment_unified_ui() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.score_fragment_unified_ui, container, false);

        // Instantiate all buttons
        final RadioButton btn_radio_team1 = (RadioButton) rootView.findViewById(R.id.radio_btn_team1);
        final RadioButton btn_radio_team2 = (RadioButton) rootView.findViewById(R.id.radio_btn_team2);
        final RadioGroup radioGroup = (RadioGroup) rootView.findViewById(R.id.radioGroup);
        final ImageButton btn_increase_score = (ImageButton) rootView.findViewById(R.id.increase_btn);
        final ImageButton btn_decrease_score = (ImageButton) rootView.findViewById(R.id.decrease_btn);
        final Button btn_instant_score = (Button) rootView.findViewById(R.id.instant_score);
        final ImageButton btn_send_score = (ImageButton) rootView.findViewById(R.id.send_score);
...
//        final Animation anim4 = AnimationUtils.loadAnimation(getContext(), R.anim.team_names);
        ...
        btn_increase_score.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i_scoreArray++;
                if(i_scoreArray > 4){
                    i_scoreArray = 0;
                    instantScore = scoreArray[i_scoreArray];
                    btn_instant_score.setText("+"+instantScore);
                ...
                btn_increase_score.startAnimation(animbutton);
            }
        });

        btn_decrease_score.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                i_scoreArray--;
                ...
                btn_decrease_score.startAnimation(animbutton);
            }
        });

        btn_send_score.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                btn_send_score.startAnimation(animbutton);

               if (!btn_radio_team1.isChecked() && !btn_radio_team2.isChecked()){

                   Toast.makeText(getContext(), "Selecione a equipe vencedora",Toast.LENGTH_SHORT).show();
               }
               else if (btn_radio_team1.isChecked()){
                mPlacarUm = mPlacarUm + instantScore;
                ...
                updatePoints(mPlacarUm, mPlacarDois);
               ...
               else if (btn_radio_team2.isChecked()){
                    mPlacarDois = mPlacarDois + instantScore;
                    placar_Dois.setText("" + checkScore(mPlacarDois));
                    placar_Dois.startAnimation(anim1);
                    updatePoints(mPlacarUm, mPlacarDois);
                    i_scoreArray = 0;
                    instantScore = scoreArray[i_scoreArray];
                    btn_instant_score.setText("+"+instantScore);
                   ...
                   Toast.makeText(getContext(), "Unkown Case",Toast.LENGTH_SHORT).show();
               }
...
//                        });
     ...
     */
    public static ScoreFragment_unified_ui getInstace() {
        return ins;
    }
            ...
            a_builder.setMessage("\nSIM: Nova rodada \n\nNÃO: Voltar jogada")
                    ...
                    .setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            try {
                                ScoreFragment_unified_ui.getInstace().updateTheTextView();
                            } catch (Exception e) {
    ...
    public void newGame (){
        ...
        //reset Instant score value
        instantScore = scoreArray[i_scoreArray];
        Button instant_score = (Button) ((Activity)getContext()).findViewById(R.id.instant_score);
        instant_score.setText("+"+instantScore);

        RadioGroup radioGroup = (RadioGroup) ((Activity)getContext()).findViewById(R.id.radioGroup);
        radioGroup.clearCheck();
